...
namespace NodeCanvas.Tasks.Actions
{
    [Name("FlowScript")]
    [Category("✫ FlowScript")]
    public class FlowScriptAction : ActionTask
    {
        [System.Serializable]
        ...
        [SerializeField]
        [Name("Function")]
        public BBParameter<ActionFunction> Reference;
        [SerializeField]
        private string title = "FlowScript";
        private ActionFunction Instance = null;
        [SerializeField]
        ...
        public void CheckInstance()
        {
            ...
            Instance.exitAction = (f) =>
            {
                ...
                EndAction(Instance.exitFunction());
            };
        ...
        protected override void OnTaskInspectorGUI()
        {
            ...
            if (Reference.value == null)
            {
                ...
                {
                    Reference.value = EditorUtils.CreateAsset<ActionFunction>(true);
                }
            }
            else
            {
