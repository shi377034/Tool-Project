...
namespace FlowCanvas.Nodes{
	...
	public class ReflectedFieldNodeWrapper : FlowNode {
...
#else
		private ReflectedFieldNode reflectedFieldNode{get;set;}
#endif
		...
		protected override void RegisterPorts(){
			...
			reflectedFieldNode = ReflectedFieldNode.Create(field);
			if (reflectedFieldNode != null){
				reflectedFieldNode.RegisterPorts(this, field, accessMode);
			}
		}
