...
namespace FlowCanvas.Nodes{
	...
	abstract public class LatentActionNodeBase : SimplexNode {
		...
		public override string name{
			get	{ return enumeratorQueue.Count > 0? string.Format("{0} [{1}]", base.name, enumeratorQueue.Count.ToString()) : base.name; }
		}

		sealed public override void OnGraphStarted(){ enumeratorQueue = new Queue<IEnumerator>(); flowQueue = new Queue<Flow>(); currentCoroutine = null; }
